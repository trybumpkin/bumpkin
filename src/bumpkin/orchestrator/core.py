...
from bumpkin.orchestrator import reasoning_trace as orchestrator_reasoning_trace
...
_row_has_semantic_transition = orchestrator_explainability.row_has_semantic_transition
_row_satisfies_patch_transition = orchestrator_explainability.row_satisfies_patch_transition
_evaluate_proof_obligations = orchestrator_explainability.evaluate_proof_obligations
_critical_missing_proof_obligations = orchestrator_explainability.critical_missing_proof_obligations
_semantic_severity_rank = orchestrator_reasoning_trace.semantic_severity_rank
_extract_contradiction_paths = orchestrator_reasoning_trace.extract_contradiction_paths
_prioritize_semantic_facts = orchestrator_reasoning_trace.prioritize_semantic_facts
_normalize_policy_id = orchestrator_reasoning_trace.normalize_policy_id
_build_reasoning_trace = orchestrator_reasoning_trace.build_reasoning_trace
_detect_contradictions = orchestrator_reasoning_trace.detect_contradictions
